...
export const isDraw = (gameBoard, currentMove, currentPlayer) => {
    ...
    return (count === 0 && !isWinner(gameBoard, currentMove, currentPlayer));
}

const getRandomSuggest= (gameBoard) =>{
    let validMoves = []
...
export const getComputerSuggest = (gameBoard) => {
    let moveChecks =  [
        {
            indexes: [0, 4, 8, 12],
            max: 4,
    ...
    return getRandomSuggest(gameBoard);
}